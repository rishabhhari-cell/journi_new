...
const envSchema = z.object({
  ...
  MODAL_LLM_URL: z.string().optional(),
  MODAL_LLM_REFORMAT_URL: z.string().optional(),
  MODAL_EMBED_URL: z.string().optional(),
  MODAL_SCRAPER_URL: z.string().optional(),
  ...
  RESEND_MENTION_TEMPLATE_ID: z.string().min(1).optional(),
  RESEND_PASSWORD_RESET_TEMPLATE_ID: z.string().min(1).optional(),
